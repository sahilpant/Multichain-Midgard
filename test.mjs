...
const phrase = await decryptFromKeystore(
  {
    ...
    crypto: {
      cipher: 'aes-128-ctr',
      ciphertext:
        'dea58fc8bca8c9ce5b728f6c8808584787bd29ed1c7906db3d1a4a8ad2e284de0c044bbf71925f359044054e33401a0b295b5b46946183ff9e5a7107859384e1c3854d7c7c3bad1632cb3c1be07a7ea6ecd0863439818f',
      ...
      kdfparams: {
        ...
        dklen: 32,
        salt:
          '761081078dfd0a93793b43536392a99396c3d90c572313de8c21abd08f71a802',
        c: 262144,
      },
      mac: 'b098da8c2282da2bdaa7b3bf35e0d88aeccd012ae346bf25b53f9c3d6269596d',
    },
    id: 'f7fe8714-39d2-4474-8861-0de189459605',
    version: 1,
...
const memo = getSwapMemo('BTC', 'BTC', bitcoinAddress, 185618);
console.log(memo);
